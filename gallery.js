$(document).ready(function() {
	...
	$("<p style='font-size:18px;width:60%;padding-left:10px;'>A gunman opened fire on beachgoers at a resort frequented by Europeans in what is widely seen as a campaign to devastate Tunisia's tourism industry.</p><p style='font-size:18px;width:60%;padding-left:10px;'>Many of the dead and injured were from Britain.</p><p style='font-family:FranklinITCProBold;font-weight:bold;padding-left:10px;'>Read:</p><p style='font-family:FranklinITCProLight;color:#2e6d9d;padding-left:10px;'>Tunisia, after igniting the Arab Spring, sends the most fighters to Islamic State in Syria</p>").appendTo('.pb-f-gallery-gallery');
});