$(document).ready(function() {
	...
	$('#liveblog-permalink').after('<div class="supplement-key" style="position:relative;float:left;"><i class="fa fa-map" style="color:#2a2a2a;"></i><span class="supp-header" style="font-family:FranklinITCProBold;color:#777;">    RELATED SUPPLEMENTS</span></div>')
