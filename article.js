$(document).ready(function() {
	...
	$('<h2><span style="display:inline-block;background-color:#DCA48D;border-radius:1em;padding:6px;margin-right:3px;"></span><span style="font-family:FranklinITCProBold;font-size:16px;">Supplement explorer</span></h2>').appendTo('.headline-kicker');
