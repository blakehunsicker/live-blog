$(document).ready(function() {
	...
	$('<h3><span style="display:inline-block;background-color:#DCA48D;border-radius:1em;padding:6px;margin-right:8px;"></span><span style="font-family:FranklinITCProBold;font-size:16px;">Supplement explorer</span></h3>').appendTo('.headline-kicker');
	$('.headline-kicker').css({
		'margin-top': '25px',
		'margin-bottom': '17px'
	});
