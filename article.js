$(document).ready(function() {
	...
	$("<div style='height:400px;background-color:#E7E7E7;'></div><div class='pb-caption'>Police officers control the crowd (rear) while surrounding a man (front center) suspected to be involved the attack on a beach in Sousse, Tunisia. (Amine Ben Aziza/Reuters)</div><div class='inline-content' style='padding:0px;border-top:none;'></div><p style='font-size:20px;'>A gunman opened fire on beachgoers at a resort frequented by Europeans in what is widely seen as a campaign to devastate Tunisia's tourism industry.</p><p style='font-size:20px;'>Many of the dead and injured were from Britain.</p><p style='font-family:FranklinITCProBold;font-weight:bold;margin-bottom:10px;'>Read:</p><p style='font-family:FranklinITCProLight;line-height:20px;color:#2e6d9d;'>Tunisia, after igniting the Arab Spring, sends the most fighters to Islamic State in Syria</p><p style='font-family:FranklinITCProLight;line-height:20px;color:#2e6d9d;margin-bottom:100px;border-bottom:1px solid #E0E0E0;'>Sousse: The beautiful Tunisian city that became a scene of terror</p><div class='pb-timestamp'>Updated September 29 at 10:21 AM</div><div style='margin-top:20px;margin-bottom:20px;border-bottom:1px solid #D5D5D5;'></div>").appendTo('article');
